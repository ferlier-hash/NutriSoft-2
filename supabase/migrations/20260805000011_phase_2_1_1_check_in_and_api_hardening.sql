...
-- Sin CASCADE: si una migración futura agrega dependientes, el reset debe
-- detenerse en lugar de eliminarlos silenciosamente.
DROP VIEW api.check_in_assignments;
...
DROP VIEW api.patient_recommendations;
