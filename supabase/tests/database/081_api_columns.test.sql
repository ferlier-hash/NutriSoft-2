...
SELECT hasnt_column('api', 'patient_directory', 'birth_date', 'api.patient_directory no expone birth_date');
SELECT hasnt_column('api', 'patient_directory', 'city', 'api.patient_directory no expone city');
SELECT hasnt_column('api', 'patient_directory', 'nutrition_goal', 'api.patient_directory no expone nutrition_goal');
...
SELECT hasnt_column('api', 'patient_recommendations', 'created_by', 'api.patient_recommendations no expone created_by');
