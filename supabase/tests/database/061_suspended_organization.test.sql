...
-- El seed puede llevar varios días activo en desarrollo local. El vencimiento
-- se fija dentro de esta transacción para que la prueba mida suspensión, no edad del contenedor.
