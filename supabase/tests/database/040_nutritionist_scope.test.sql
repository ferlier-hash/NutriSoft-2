...
SELECT results_eq('SELECT COUNT(*)::integer FROM app.patients WHERE id = ''pat33333-3333-4333-8333-333333333333''', ARRAY[0]);
...
SELECT results_eq('SELECT COUNT(*)::integer FROM app.patients WHERE id IN (''pat11111-1111-4111-8111-111111111111'', ''pat22222-2222-4222-8222-222222222222'')', ARRAY[0]);
