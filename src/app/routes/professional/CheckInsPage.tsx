...
export function CheckInsPage() {
  ...
  return <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
    ...
    <section className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_19rem] gap-4" aria-labelledby="checkin-weekly-title">
      ...
      <Card className="space-y-3"><p className="text-sm font-bold text-text-primary">Alertas de inactividad</p><div className="grid grid-cols-2 gap-2 text-center sm:grid-cols-3"><div className="rounded-xl bg-surface-subtle p-3"><p className="text-lg font-bold text-text-primary">{inactive3to4}</p><p className="text-xs text-text-secondary">3–4 días</p></div><div className="rounded-xl bg-semantic-warning/10 p-3"><p className="text-lg font-bold text-text-primary">{inactive5to9}</p><p className="text-xs text-text-secondary">5–9 días</p></div><div className="col-span-2 rounded-xl bg-semantic-critical/10 p-3 sm:col-span-1"><p className="text-lg font-bold text-text-primary">{inactive10plus}</p><p className="text-xs text-text-secondary">10+ días</p></div></div><p className="text-[11px] text-text-tertiary">Las alertas se agrupan para evitar duplicar a una misma persona en varios conteos.</p></Card>
    </section>
